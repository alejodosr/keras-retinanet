...
def ResNet18(inputs, blocks=None, include_top=True, classes=1000, *args, **kwargs):
    ...
    return ResNet(inputs, blocks, block=keras_resnet_blocks.basic_2d, include_top=include_top, classes=classes, *args, **kwargs)
...
def ResNet50(inputs, blocks=None, include_top=True, classes=1000, *args, **kwargs):
    ...
    return ResNet(inputs, blocks, numerical_names=numerical_names, block=keras_resnet_blocks.bottleneck_2d, include_top=include_top, classes=classes, *args, **kwargs)
